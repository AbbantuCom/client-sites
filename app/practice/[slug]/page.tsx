...
import { getNextPractice, getPractice, practices } from '@/lib/practices';
...
export default async function PracticeDetailPage({ params }: PageProps) {
  ...
  const next = getNextPractice(practice.slug);
        ...
        <div className="container detail-layout detail-layout--editorial">
          ...
          <div>
            ...
            <section className="detail-section practice-team-section" id="team" data-reveal>
              ...
              {practice.team ? (
                <Link className="practice-lead" href={`/team/${practice.team.slug}`}>
                  <Image
                    src={practice.team.image}
                    alt={practice.team.name}
                  ...
                  <div>
                    ...
                    <h2>{practice.team.name}</h2>
                    <p>{practice.team.role}</p>
