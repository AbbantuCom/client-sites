          ...
          <div>
            ...
            <section className="detail-section" id="who-we-are" data-reveal>
              ...
              <p>
                ...
                this website. You can reach us at {site.address.full}, by email at{' '}
            ...
            <section className="detail-section" id="appointment-form" data-reveal>
              ...
              <p>
                The appointment form on our{' '}
                <Link className="blog-inline-link" href="/contact">
                  contact page
                </Link>{' '}
                does not transmit anything to this website or to any server of ours. When you submit
                it, the details you typed are used to open a message in your own email application,
                addressed to {site.email}, which you then send yourself. Until you press send in your
                own email programme, your details never leave your device.
              </p>
              <p>
                Once you do send that email, we hold it as we would any other enquiry: we use it to
                respond to you, and to decide whether we are able to act for you. If we take you on
                as a client, our engagement terms take over from this policy.
              </p>
            </section>
