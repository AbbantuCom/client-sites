...
/** The four lawyers featured on the home page, in display order. */
export const featuredTeam = ['galandi', 'baluku', 'masika', 'muzingu']
  .map((slug) => team.find((person) => person.slug === slug))
...
export function getNextPerson(slug: string): Person {
